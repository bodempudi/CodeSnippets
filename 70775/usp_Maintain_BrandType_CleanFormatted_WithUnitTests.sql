...
BEGIN
    ...
    BEGIN
        SELECT @StatusCode = 1, @StatusMessage = 'ActionType is mandatory.'
    ...
    BEGIN
        SELECT @StatusCode = 1, @StatusMessage = 'Invalid ActionType.'
        SELECT @StatusCode AS StatusCode, @StatusMessage AS StatusMessage
        RETURN
    END
    ...
    BEGIN
        SELECT @StatusCode = 1, @StatusMessage = 'UserID is mandatory.'
        SELECT @StatusCode AS StatusCode, @StatusMessage AS StatusMessage
        RETURN
    END
    ...
    BEGIN
        ...
        BEGIN
            SELECT @StatusCode = 1, @StatusMessage = 'BrandTypeCode is mandatory.'
            SELECT @StatusCode AS StatusCode, @StatusMessage AS StatusMessage
            RETURN
        END
        ...
        BEGIN
            SELECT @StatusCode = 1, @StatusMessage = 'BrandTypeNameEN is mandatory.'
            SELECT @StatusCode AS StatusCode, @StatusMessage AS StatusMessage
            RETURN
        END
    END
    ...
    BEGIN
        SELECT @StatusCode = 1, @StatusMessage = 'BrandTypeID is mandatory.'
        SELECT @StatusCode AS StatusCode, @StatusMessage AS StatusMessage
        RETURN
    END
